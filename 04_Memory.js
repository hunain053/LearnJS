...
let myName = "Hunain Mahudawala";
let anotherName = myName;
myName = "hunain";
console.log(myName); // Output: hunain
console.log(anotherName); // Output: hunain mahudawala
...
let person = { name: "hunain", age: 20 };
let anotherPerson = person;
person.name = "hunain mahudawala"; 
console.log(person.name); // Output: hunain mahudawala
console.log(anotherPerson.name); // Output: hunain mahudawala
